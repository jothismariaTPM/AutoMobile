...
const Cart = () => {
   ...
   const {products,currency, cartItems, setCartItems, getCartCount, removeFromCart, getCartAmount, updateCartItem, user, axios, navigate, country, inrToAed } = useAppContext();
            ...
            <div className='flex-1 max-w-4xl'>
                ...
                {cartArray.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        ...
                        <p className="text-center">{country === "AE" ? `AED ${convertINRtoAED(product?.offerPrice) * product.quantity}` : `₹${product?.offerPrice * product.quantity}`}</p>
