      ...
      <div className="max-w-7xl md:p-10 transition-all duration-300">
        ...
        {[
          ...
          },
          {
            ...
            content: (
              <>
              <p>If you are located in the EEA, we process your data based on:</p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          },
          {
            ...
            content: (
             <>
              ...
              <p>We use strong technical and organizational measures to protect your data against unauthorized access, alteration, loss, or misuse.</p>
...
We ensure such transfers follow applicable data protection requirements.
          ...
          },
          {
            ...
            content: (
              <p className="text-gray-700 leading-relaxed">
                We may update this Privacy Policy periodically. Revised versions will be posted on this page with an updated “Effective Date.”
Please review this policy regularly.
          ...
          <section
            key={index}
            className="mb-8 border-l-4 border-orange-400 pl-5 py-5 hover:bg-gray-50 rounded-md transition-colors duration-200"
          >
