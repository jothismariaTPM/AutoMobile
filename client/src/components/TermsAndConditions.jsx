...
We reserve the right to cancel orders in case of suspected fraud or incorrect pricing.
    ...
    },
    {
      ...
      content: (
        ...
        <ul className="list-disc list-inside my-3 space-y-2 text-gray-700">
    ...
    },
    {
      ...
      content: (
        ...
        <p>You may not:</p>
        <ul className="list-disc list-inside my-3 px-3 space-y-2 text-gray-700">
          <li>Copy</li>
          <li>Distribute</li>
          <li>Modify</li>
          <li>Reproduce</li>
...
We do not guarantee:</p>
    ...
    },
    {
      ...
      content: (
        ...
        <p>Updated Terms will be posted on this page with a revised <strong>5/12/2025.</strong></p>
    ...
    },
    {
      ...
      content: (
        ...
        <p>
           Any disputes shall be subject to the exclusive jurisdiction of courts in Kerala, India.
        </p>
        </>
      ),
    },
    {
      ...
      content: (
        ...
        <p className="text-gray-700 leading-relaxed">You may request cancellation before the order is shipped.</p>
        <p className="text-gray-700 leading-relaxed mb-2">No refunds are provided for:</p>
        <ul className="list-disc list-inside my-1 px-3 space-y-1 text-gray-700">
        ...
        <ul className="list-disc list-inside my-1 px-3 space-y-1 text-gray-700">
          <li>Contact us within 7 days at pullmaneurospare@gmail.com</li>
    ...
    <div className="min-h-screen py-16 px-6 flex justify-center">
      <div className="max-w-7xl md:p-10 transition-all duration-300">
        <header className="border-b border-gray-200 pb-6 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            By accessing or using the Pullman Euro Car Spare website (“Service” or “Platform”), you (“you,” “your,” or “User”) agree to comply with and be bound by these Terms and Conditions (“Terms”).
          </p>
          <p>
        ...
        {sections.map((section, index) => (
          <section
            key={index}
            className="mb-8 border-l-4 border-[#25AFB2] pl-5 py-5 rounded-md hover:bg-gray-50 transition-colors duration-200"
          >
